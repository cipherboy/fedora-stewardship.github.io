...
| ------- | ------------ | ------------ | ------ |
| ant | 1.10.6 | 1.10.7 | 191 days behind |
| ant-antunit | 1.3 | 1.4 | 627 days behind |
...
| apache-commons-vfs | 2.4.1 | 2.6.0 | 76 days behind |
| apache-ivy | 2.4.0 | 2.5.0 | 142 days behind |
| apache-parent | 23 | 23 | current |
| apache-resource-bundles | 2 | 2 | current |
| apiguardian | 1.1.0 | 1.1.0 | current |
| aqute-bnd | 3.5.0 | 5.0.0 | 669 days behind |
| args4j | 2.33 | 2.33 | current |
| assertj-core | 3.8.0 | 3.15.0 | 798 days behind |
...
| cdi-api | 1.2 | 2.0.0 | 1036 days behind |
| codemodel | 2.6 | 2.6 | current |
| dain-snappy | 0.4 | 0.4 | current |
| disruptor | 3.3.6 | 3.4.2 | 894 days behind |
| easymock | 3.6 | 4.2 | 500 days behind |
| exec-maven-plugin | 1.6.0 | 1.6.0 | current |
| fasterxml-oss-parent | 38 | 38 | current |
| felix-bundlerepository | 2.0.10 | 2.0.10 | current |
| felix-framework | 5.6.0 | 6.0.3 | 1236 days behind |
| felix-osgi-obr | 1.0.2 | 1.0.2 | current |
| felix-osgi-obr-resolver | 1.8.0 | 2.0.0 | 1265 days behind |
| felix-parent | 4 | 6 | 691 days behind |
...
| glassfish-dtd-parser | 1.4 | 1.4.2 | 438 days behind |
| glassfish-fastinfoset | 1.2.15 | 1.2.17 | 439 days behind |
| glassfish-hk2 | 2.5.0 | 2.6.1 | 223 days behind |
| glassfish-jax-rs-api | 2.1.6 | 2.1.6 | current |
| glassfish-jaxb | 2.2.11 | 2.3.2 | 951 days behind |
| glassfish-jaxb-api | 2.2.12~b141001.1542 | 2.3.1 | 1968 days behind |
...
| guava | 25.0 | 28.2 | 657 days behind |
| guava20 | 20.0 | 20.0 | current |
| hamcrest | 1.3 | 2.2 | 446 days behind |
| hawtjni | 1.17 | 1.17 | current |
| httpcomponents-project | 11 | 11 | current |
| isorelax | 0 | 0 | current |
| istack-commons | 2.21 | 3.0.10 | 1737 days behind |
| jackson-annotations | 2.10.3 | 2.20.3 | 7 days behind |
| jackson-core | 2.10.3 | 2.20.3 | 7 days behind |
| jackson-databind | 2.10.3 | 2.20.3 | 7 days behind |
| jackson-jaxrs-providers | 2.10.3 | 2.20.3 | 7 days behind |
| jackson-modules-base | 2.10.3 | 2.20.3 | 7 days behind |
| jackson-parent | 2.10 | 2.10 | current |
| jakarta-commons-httpclient | 3.1 | 3.1 | current |
| janino | 2.7.8 | 3.1.0 | 1342 days behind |
| jansi | 1.18 | 1.18 | current |
| jansi-native | 1.8 | 1.8 | current |
| java_cup | 0.11~beta | 0.11~beta | current |
| javacc | 7.0.4 | 7.0.5 | 142 days behind |
| javacc-maven-plugin | 2.6 | 2.6 | current |
| javaparser | 3.3.5 | 3.15.11 | 905 days behind |
| javassist | 3.18.1 | 3.26.0 | 2114 days behind |
| jaxen | 1.2.0 | 1.2.0 | current |
| jboss-annotations-1.2-api | 1.0.2 | 1.0.2 | current |
| jboss-el-2.2-api | 1.0.5 | 1.0.6 | 1441 days behind |
| jboss-el-3.0-api | 1.0.13 | 2.0.0 | 181 days behind |
| jboss-interceptors-1.2-api | 1.0.1 | 2.0.0 | 182 days behind |
| jboss-jaxrs-2.0-api | 1.0.0 | 1.0.1 | 778 days behind |
| jboss-logging | 3.4.1 | 3.4.1 | current |
| jboss-logging-tools | 2.2.0 | 2.2.1 | 110 days behind |
| jboss-modules | 1.5.2 | 1.9.2 | 1078 days behind |
| jboss-servlet-3.0-api | 1.0.2 | 1.0.2 | current |
| jboss-servlet-3.1-api | 1.0.2 | 1.0.2 | current |
| jctools | 2.1.2 | 3.0.0 | 67 days behind |
| jdeparser | 2.0.3 | 2.0.3 | current |
| jdepend | 2.9.1 | 2.9.1 | current |
| jdependency | 1.2 | 2.3.0 | 798 days behind |
| jdom2 | 2.0.6 | 2.0.6 | current |
| jetty-parent | 19 | 25 | 2759 days behind |
| jetty-toolchain | 1.4 | 1.7 | 1835 days behind |
| jflex | 1.7.0 | 1.8.0 | 11 days behind |
| jmock | 2.8.2 | 2.12.0 | 999 days behind |
| jna | 5.4.0 | 5.5.0 | 132 days behind |
| joda-convert | 1.9.2 | 2.2.1 | 754 days behind |
| jsoup | 1.12.1 | 1.13.1 | 30 days behind |
| junit | 4.12 | 4.13 | 69 days behind |
...
| maven-doxia-sitetools | 1.9.1 | 1.9.2 | 20 days behind |
| maven-enforcer | 3.0.0~M2 | 3.0.0~M3 | 113 days behind |
...
| maven-parent | 33 | 34 | 44 days behind |
| maven-plugin-build-helper | 1.9.1 | 3.0.0 | 1571 days behind |
| maven-plugin-bundle | 3.5.1 | 4.2.1 | 560 days behind |
| maven-plugin-testing | 3.3.0 | 3.3.0 | current |
| maven-plugin-tools | 3.5.1 | 3.6.0 | 660 days behind |
| maven-remote-resources-plugin | 1.5 | 1.7.0 | 499 days behind |
...
| maven-source-plugin | 3.2.0 | 3.2.1 | 85 days behind |
| maven-surefire | 2.22.0 | 3.0.0~M4 | 520 days behind |
| maven-verifier | 1.6 | 1.6 | current |
| maven-wagon | 3.2.0 | 3.3.4 | 432 days behind |
| modello | 1.10.0 | 1.11 | 274 days behind |
| mojo-parent | 40 | 50 | 471 days behind |
...
| plexus-bsh-factory | 1.0~alpha7 | 1.0~alpha9 | 4853 days behind |
...
| resteasy | 3.0.26 | 4.4.2 | 1183 days behind |
...
| snappy-java | 1.1.2.4 | 1.1.7.3 | 1377 days behind |
| sonatype-oss-parent | 7 | 7 | current |
| spec-version-maven-plugin | 1.2 | 2.1 | 561 days behind |
| spice-parent | 26 | 26 | current |
| stax-ex | 1.7.7 | 1.8.2 | 1152 days behind |
| stax2-api | 4.2 | 4.2 | current |
| testng | 6.14.3 | 7.1.0 | 206 days behind |
...
| xbean | 4.15 | 4.16 | 39 days behind |
| xmlstreambuffer | 1.5.4 | 1.5.8 | 629 days behind |
