...
| ------- | ------------ | ------------ | ------ |
| ant | 1.10.6 | 1.10.7 | 183 days behind |
| ant-antunit | 1.3 | 1.4 | 619 days behind |
...
| apache-commons-compress | 1.19 | 1.20 | 26 days behind |
| apache-commons-daemon | 1.2.2 | 1.2.2 | current |
| apache-commons-jxpath | 1.3 | 1.3 | current |
| apache-commons-lang | 2.6 | 2.6 | current |
| apache-commons-vfs | 2.4.1 | 2.6.0 | 68 days behind |
| apache-ivy | 2.4.0 | 2.5.0 | 134 days behind |
| apache-parent | 22 | 23 | 40 days behind |
| apache-resource-bundles | 2 | 2 | current |
| apiguardian | 1.1.0 | 1.1.0 | current |
| aqute-bnd | 3.5.0 | 5.0.0 | 661 days behind |
| args4j | 2.33 | 2.33 | current |
| assertj-core | 3.8.0 | 3.15.0 | 790 days behind |
...
| cdi-api | 1.2 | 2.0.0 | 1028 days behind |
| codemodel | 2.6 | 2.6 | current |
| cpptasks | 1.0~b5 | 1.0~b5 | current |
| dain-snappy | 0.4 | 0.4 | current |
| disruptor | 3.3.6 | 3.4.2 | 886 days behind |
| easymock | 3.6 | 4.2 | 492 days behind |
| exec-maven-plugin | 1.6.0 | 1.6.0 | current |
| fasterxml-oss-parent | 38 | 38 | current |
| felix-bundlerepository | 2.0.10 | 2.0.10 | current |
| felix-framework | 5.6.0 | 6.0.3 | 1228 days behind |
| felix-osgi-obr | 1.0.2 | 1.0.2 | current |
| felix-osgi-obr-resolver | 1.8.0 | 2.0.0 | 1257 days behind |
| felix-parent | 4 | 6 | 683 days behind |
| felix-shell | 1.4.3 | 1.4.3 | current |
| felix-utils | 1.11.2 | 1.11.4 | 113 days behind |
...
| glassfish-dtd-parser | 1.4 | 1.4.2 | 430 days behind |
| glassfish-fastinfoset | 1.2.15 | 1.2.17 | 431 days behind |
| glassfish-hk2 | 2.5.0 | 2.6.1 | 215 days behind |
| glassfish-jax-rs-api | 2.1.6 | 2.1.6 | current |
| glassfish-jaxb | 2.2.11 | 2.3.2 | 943 days behind |
| glassfish-jaxb-api | 2.2.12~b141001.1542 | 2.3.1 | 1960 days behind |
...
| guava | 25.0 | 28.2 | 649 days behind |
| guava20 | 20.0 | 20.0 | current |
| hamcrest | 1.3 | 2.2 | 438 days behind |
| hawtjni | 1.17 | 1.17 | current |
| httpcomponents-project | 11 | 11 | current |
| isorelax | 0 | 0 | current |
| istack-commons | 2.21 | 3.0.10 | 1729 days behind |
| jackson-annotations | 2.10.2 | 2.10.2 | current |
| jackson-core | 2.10.2 | 2.10.2 | current |
| jackson-databind | 2.10.2 | 2.10.2 | current |
| jackson-jaxrs-providers | 2.10.2 | 2.10.2.1 | 33 days behind |
| jackson-modules-base | 2.10.2 | 2.10.2 | current |
| jackson-parent | 2.10 | 2.10 | current |
| jakarta-commons-httpclient | 3.1 | 3.1 | current |
| janino | 2.7.8 | 3.1.0 | 1334 days behind |
| jansi | 1.18 | 1.18 | current |
| jansi-native | 1.8 | 1.8 | current |
| java_cup | 0.11~beta | 0.11~beta | current |
| javacc | 7.0.4 | 7.0.5 | 134 days behind |
| javacc-maven-plugin | 2.6 | 2.6 | current |
| javaparser | 3.3.5 | 3.15.11 | 897 days behind |
| javassist | 3.18.1 | 3.26.0 | 2106 days behind |
| jaxen | 1.2.0 | 1.2.0 | current |
| jboss-annotations-1.2-api | 1.0.2 | 1.0.2 | current |
| jboss-el-2.2-api | 1.0.5 | 1.0.6 | 1433 days behind |
| jboss-el-3.0-api | 1.0.13 | 2.0.0 | 173 days behind |
| jboss-interceptors-1.2-api | 1.0.1 | 2.0.0 | 174 days behind |
| jboss-jaxrs-2.0-api | 1.0.0 | 1.0.1 | 770 days behind |
| jboss-logging | 3.4.1 | 3.4.1 | current |
| jboss-logging-tools | 2.2.0 | 2.2.1 | 102 days behind |
| jboss-modules | 1.5.2 | 1.9.2 | 1070 days behind |
| jboss-servlet-3.0-api | 1.0.2 | 1.0.2 | current |
| jboss-servlet-3.1-api | 1.0.2 | 1.0.2 | current |
| jctools | 2.1.2 | 3.0.0 | 59 days behind |
| jdeparser | 2.0.3 | 2.0.3 | current |
| jdepend | 2.9.1 | 2.9.1 | current |
| jdependency | 1.2 | 2.3.0 | 790 days behind |
| jdom2 | 2.0.6 | 2.0.6 | current |
| jetty-build-support | 1.4 | 1.5 | 459 days behind |
| jetty-parent | 19 | 25 | 2751 days behind |
| jetty-toolchain | 1.4 | 1.7 | 1827 days behind |
| jflex | 1.7.0 | 1.8.0 | 3 days behind |
| jmock | 2.8.2 | 2.12.0 | 991 days behind |
| jna | 5.4.0 | 5.5.0 | 124 days behind |
| joda-convert | 1.9.2 | 2.2.1 | 746 days behind |
| jsoup | 1.12.1 | 1.13.1 | 22 days behind |
| junit | 4.12 | 4.13 | 61 days behind |
| junit5 | 5.6.0 | 5.6.0 | current |
| jvnet-parent | 5 | 5 | current |
| kxml | 2.3.0 | 2.3.0 | current |
| log4j | 2.13.0 | 2.13.1 | 5 days behind |
| log4j12 | 1.2.17 | 1.2.17 | current |
| maven | 3.6.1 | 3.6.3 | 188 days behind |
| maven-antrun-plugin | 1.8 | 1.8 | current |
| maven-archiver | 3.5.0 | 3.5.0 | current |
| maven-artifact-resolver | 1.0 | 1.0 | current |
| maven-artifact-transfer | 0.11.0 | 0.12.0 | 97 days behind |
| maven-assembly-plugin | 3.2.0 | 3.2.0 | current |
| maven-clean-plugin | 3.1.0 | 3.1.0 | current |
| maven-common-artifact-filters | 3.0.1 | 3.1.0 | 443 days behind |
...
| maven-doxia-sitetools | 1.9.1 | 1.9.2 | 12 days behind |
| maven-enforcer | 3.0.0~M2 | 3.0.0~M3 | 105 days behind |
...
| maven-parent | 33 | 34 | 36 days behind |
| maven-plugin-build-helper | 1.9.1 | 3.0.0 | 1563 days behind |
| maven-plugin-bundle | 3.5.1 | 4.2.1 | 552 days behind |
| maven-plugin-testing | 3.3.0 | 3.3.0 | current |
| maven-plugin-tools | 3.5.1 | 3.6.0 | 652 days behind |
| maven-remote-resources-plugin | 1.5 | 1.7.0 | 491 days behind |
...
| maven-source-plugin | 3.2.0 | 3.2.1 | 77 days behind |
| maven-surefire | 2.22.0 | 3.0.0~M4 | 512 days behind |
| maven-verifier | 1.6 | 1.6 | current |
| maven-wagon | 3.2.0 | 3.3.4 | 424 days behind |
| modello | 1.10.0 | 1.11 | 266 days behind |
| mojo-parent | 40 | 50 | 463 days behind |
| munge-maven-plugin | 1.0 | 1.0 | current |
| mvel | 2.2.8 | 2.4.7 | 1356 days behind |
| objectweb-pom | 1.5 | 1.5 | current |
| opentest4j | 1.1.0 | 1.2.0 | 539 days behind |
...
| plexus-archiver | 4.2.1 | 4.2.2 | 2 days behind |
| plexus-bsh-factory | 1.0~alpha7 | 1.0~alpha9 | 4845 days behind |
...
| plexus-languages | 1.0.3 | 1.0.5 | 92 days behind |
| plexus-pom | 6.1 | 6.2 | 12 days behind |
...
| snappy-java | 1.1.2.4 | 1.1.7.3 | 1369 days behind |
| sonatype-oss-parent | 7 | 7 | current |
| spec-version-maven-plugin | 1.2 | 2.1 | 553 days behind |
| spice-parent | 26 | 26 | current |
| stax-ex | 1.7.7 | 1.8.2 | 1144 days behind |
| stax2-api | 4.2 | 4.2 | current |
| testng | 6.14.3 | 7.1.0 | 198 days behind |
...
| woodstox-core | 6.0.3 | 6.1.1 | 4 days behind |
| xalan-j2 | 2.7.2 | 2.7.2 | current |
| xbean | 4.15 | 4.16 | 31 days behind |
| xmlstreambuffer | 1.5.4 | 1.5.8 | 621 days behind |
