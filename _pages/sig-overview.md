...
| ------- | ------------ | ------------ | ------ |
| ant | 1.10.6 | 1.10.7 | 243 days behind |
...
| apache-commons-vfs | 2.4.1 | 2.6.0 | 128 days behind |
| apache-ivy | 2.4.0 | 2.5.0 | 194 days behind |
| apache-parent | 23 | 23 | current |
| apache-resource-bundles | 2 | 2 | current |
| apiguardian | 1.1.0 | 1.1.0 | current |
| aqute-bnd | 3.5.0 | 5.0.0 | 721 days behind |
| args4j | 2.33 | 2.33 | current |
| assertj-core | 3.8.0 | 3.15.0 | 850 days behind |
...
| cdi-api | 1.2 | 2.0.0 | 1088 days behind |
| dain-snappy | 0.4 | 0.4 | current |
| disruptor | 3.3.6 | 3.4.2 | 946 days behind |
| easymock | 3.6 | 4.2 | 552 days behind |
| exec-maven-plugin | 1.6.0 | 1.6.0 | current |
| fasterxml-oss-parent | 38 | 38 | current |
| felix-bundlerepository | 2.0.10 | 2.0.10 | current |
| felix-framework | 5.6.12 | 6.0.3 | 668 days behind |
| felix-osgi-obr | 1.0.2 | 1.0.2 | current |
| felix-osgi-obr-resolver | 1.16.0 | 2.0.0 | 668 days behind |
...
| glassfish-hk2 | 2.5.0 | 2.6.1 | 275 days behind |
| glassfish-jax-rs-api | 2.1.6 | 2.1.6 | current |
| glassfish-jaxb | 2.2.11 | 2.3.2 | 1003 days behind |
| glassfish-jaxb-api | 2.2.12~b141001.1542 | 2.3.1 | 2020 days behind |
...
| guava | 25.0 | 29.0 | 709 days behind |
| hamcrest | 1.3 | 2.2 | 498 days behind |
| hawtjni | 1.17 | 1.17 | current |
| httpcomponents-project | 11 | 11 | current |
| isorelax | 0 | 0 | current |
| jackson-annotations | 2.10.3 | 2.11.0 | 6 days behind |
| jackson-core | 2.10.3 | 2.11.0 | 6 days behind |
| jackson-databind | 2.10.3 | 2.11.0 | 5 days behind |
| jackson-jaxrs-providers | 2.10.3 | 2.11.0 | 5 days behind |
| jackson-modules-base | 2.10.3 | 2.11.0 | 5 days behind |
| jackson-parent | 2.10 | 2.11 | 42 days behind |
| jakarta-commons-httpclient | 3.1 | 3.1 | current |
| janino | 2.7.8 | 3.1.2 | 1394 days behind |
| jansi | 1.18 | 1.18 | current |
| jansi-native | 1.8 | 1.8 | current |
| java_cup | 0.11~beta | 0.11~beta | current |
| javacc | 7.0.4 | 7.0.6 | 194 days behind |
| javacc-maven-plugin | 2.6 | 2.6 | current |
| javaparser | 3.3.5 | 3.15.21 | 957 days behind |
| javassist | 3.21.0 | 3.27.0 | 934 days behind |
| jaxen | 1.2.0 | 1.2.0 | current |
| jboss-annotations-1.2-api | 1.0.2 | 1.0.2 | current |
| jboss-el-2.2-api | 1.0.5 | 1.0.6 | 1493 days behind |
| jboss-el-3.0-api | 1.0.13 | 2.0.0 | 233 days behind |
| jboss-interceptors-1.2-api | 1.0.1 | 2.0.0 | 234 days behind |
| jboss-jaxrs-2.0-api | 1.0.0 | 1.0.1 | 830 days behind |
| jboss-logging | 3.4.1 | 3.4.1 | current |
| jboss-logging-tools | 2.2.0 | 2.2.1 | 162 days behind |
| jboss-modules | 1.5.2 | 1.9.2 | 1130 days behind |
| jboss-servlet-3.0-api | 1.0.2 | 1.0.2 | current |
| jboss-servlet-3.1-api | 1.0.2 | 1.0.2 | current |
| jctools | 2.1.2 | 3.0.0 | 119 days behind |
| jdeparser | 2.0.3 | 2.0.3 | current |
| jdepend | 2.9.1 | 2.9.1 | current |
| jdependency | 1.2 | 2.3.0 | 850 days behind |
| jdom2 | 2.0.6 | 2.0.6 | current |
| jflex | 1.7.0 | 1.8.0 | 63 days behind |
| jmock | 2.8.2 | 2.12.0 | 1051 days behind |
| jna | 5.4.0 | 5.5.0 | 184 days behind |
| joda-convert | 1.9.2 | 2.2.1 | 806 days behind |
| jsoup | 1.12.1 | 1.13.1 | 82 days behind |
| junit | 4.12 | 4.13 | 121 days behind |
| junit5 | 5.6.0 | 5.6.2 | 40 days behind |
| jvnet-parent | 5 | 5 | current |
| kxml | 2.3.0 | 2.3.0 | current |
| log4j | 2.13.1 | 2.13.1 | current |
| log4j12 | 1.2.17 | 1.2.17 | current |
| maven | 3.6.1 | 3.6.3 | 248 days behind |
| maven-antrun-plugin | 1.8 | 3.0.0 | 19 days behind |
| maven-archiver | 3.5.0 | 3.5.0 | current |
| maven-artifact-resolver | 1.0 | 1.0 | current |
| maven-artifact-transfer | 0.11.0 | 0.12.0 | 157 days behind |
| maven-assembly-plugin | 3.2.0 | 3.2.0 | current |
| maven-clean-plugin | 3.1.0 | 3.1.0 | current |
| maven-common-artifact-filters | 3.0.1 | 3.1.0 | 503 days behind |
...
| maven-enforcer | 3.0.0~M2 | 3.0.0~M3 | 165 days behind |
...
| maven-javadoc-plugin | 3.1.1 | 3.2.0 | 50 days behind |
| maven-osgi | 0.2.0 | 0.2.0 | current |
| maven-parent | 34 | 34 | current |
| maven-plugin-build-helper | 1.9.1 | 3.0.0 | 1623 days behind |
| maven-plugin-bundle | 3.5.1 | 4.2.1 | 612 days behind |
| maven-plugin-testing | 3.3.0 | 3.3.0 | current |
| maven-plugin-tools | 3.6.0 | 3.6.0 | current |
| maven-remote-resources-plugin | 1.5 | 1.7.0 | 551 days behind |
...
| maven-shade-plugin | 3.2.1 | 3.2.3 | 79 days behind |
...
| maven-surefire | 2.22.0 | 3.0.0~M4 | 572 days behind |
| maven-verifier | 1.6 | 1.7.1 | 35 days behind |
| maven-wagon | 3.2.0 | 3.3.4 | 484 days behind |
| modello | 1.10.0 | 1.11 | 326 days behind |
| mojo-parent | 40 | 50 | 523 days behind |
...
| resteasy | 3.0.26 | 4.4.2 | 1235 days behind |
| shrinkwrap | 1.2.6 | 1.2.6 | current |
| sisu | 0.3.4 | 0.3.4 | current |
| sisu-mojos | 0.3.4 | 0.3.4 | current |
| slf4j | 1.7.30 | 1.7.30 | current |
| snakeyaml | 1.25 | 1.26 | 63 days behind |
| snappy-java | 1.1.2.4 | 1.1.7.3 | 1429 days behind |
| sonatype-oss-parent | 7 | 7 | current |
| spec-version-maven-plugin | 1.2 | 2.1 | 613 days behind |
| spice-parent | 26 | 26 | current |
| stax2-api | 4.2 | 4.2 | current |
| testng | 6.14.3 | 7.1.0 | 258 days behind |
...
| woodstox-core | 6.1.1 | 6.2.0 | 6 days behind |
| xalan-j2 | 2.7.2 | 2.7.2 | current |
| xbean | 4.15 | 4.16 | 91 days behind |
