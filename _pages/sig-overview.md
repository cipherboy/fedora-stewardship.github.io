...
| ------- | ------------ | ------------ | ------ |
| ant | 1.10.6 | 1.10.7 | 199 days behind |
...
| apache-commons-vfs | 2.4.1 | 2.6.0 | 84 days behind |
| apache-ivy | 2.4.0 | 2.5.0 | 150 days behind |
| apache-parent | 23 | 23 | current |
| apache-resource-bundles | 2 | 2 | current |
| apiguardian | 1.1.0 | 1.1.0 | current |
| aqute-bnd | 3.5.0 | 5.0.0 | 677 days behind |
| args4j | 2.33 | 2.33 | current |
| assertj-core | 3.8.0 | 3.15.0 | 806 days behind |
...
| cdi-api | 1.2 | 2.0.0 | 1044 days behind |
| codemodel | 2.6 | 2.6 | current |
| dain-snappy | 0.4 | 0.4 | current |
| disruptor | 3.3.6 | 3.4.2 | 902 days behind |
| easymock | 3.6 | 4.2 | 508 days behind |
| exec-maven-plugin | 1.6.0 | 1.6.0 | current |
| fasterxml-oss-parent | 38 | 38 | current |
| felix-bundlerepository | 2.0.10 | 2.0.10 | current |
| felix-framework | 5.6.0 | 6.0.3 | 1244 days behind |
| felix-osgi-obr | 1.0.2 | 1.0.2 | current |
| felix-osgi-obr-resolver | 1.8.0 | 2.0.0 | 1273 days behind |
| felix-parent | 4 | 6 | 699 days behind |
...
| glassfish-dtd-parser | 1.4 | 1.4.2 | 446 days behind |
| glassfish-fastinfoset | 1.2.15 | 1.2.17 | 447 days behind |
| glassfish-hk2 | 2.5.0 | 2.6.1 | 231 days behind |
| glassfish-jax-rs-api | 2.1.6 | 2.1.6 | current |
| glassfish-jaxb | 2.2.11 | 2.3.2 | 959 days behind |
| glassfish-jaxb-api | 2.2.12~b141001.1542 | 2.3.1 | 1976 days behind |
...
| guava | 25.0 | 28.2 | 665 days behind |
| guava20 | 20.0 | 20.0 | current |
| hamcrest | 1.3 | 2.2 | 454 days behind |
| hawtjni | 1.17 | 1.17 | current |
| httpcomponents-project | 11 | 11 | current |
| isorelax | 0 | 0 | current |
| istack-commons | 2.21 | 3.0.10 | 1745 days behind |
...
| janino | 2.7.8 | 3.1.0 | 1350 days behind |
| jansi | 1.18 | 1.18 | current |
| jansi-native | 1.8 | 1.8 | current |
| java_cup | 0.11~beta | 0.11~beta | current |
| javacc | 7.0.4 | 7.0.5 | 150 days behind |
| javacc-maven-plugin | 2.6 | 2.6 | current |
| javaparser | 3.3.5 | 3.15.11 | 913 days behind |
| javassist | 3.18.1 | 3.26.0 | 2122 days behind |
| jaxen | 1.2.0 | 1.2.0 | current |
| jboss-annotations-1.2-api | 1.0.2 | 1.0.2 | current |
| jboss-el-2.2-api | 1.0.5 | 1.0.6 | 1449 days behind |
| jboss-el-3.0-api | 1.0.13 | 2.0.0 | 189 days behind |
| jboss-interceptors-1.2-api | 1.0.1 | 2.0.0 | 190 days behind |
| jboss-jaxrs-2.0-api | 1.0.0 | 1.0.1 | 786 days behind |
| jboss-logging | 3.4.1 | 3.4.1 | current |
| jboss-logging-tools | 2.2.0 | 2.2.1 | 118 days behind |
| jboss-modules | 1.5.2 | 1.9.2 | 1086 days behind |
| jboss-servlet-3.0-api | 1.0.2 | 1.0.2 | current |
| jboss-servlet-3.1-api | 1.0.2 | 1.0.2 | current |
| jctools | 2.1.2 | 3.0.0 | 75 days behind |
| jdeparser | 2.0.3 | 2.0.3 | current |
| jdepend | 2.9.1 | 2.9.1 | current |
| jdependency | 1.2 | 2.3.0 | 806 days behind |
| jdom2 | 2.0.6 | 2.0.6 | current |
| jetty-parent | 19 | 25 | 2767 days behind |
| jflex | 1.7.0 | 1.8.0 | 19 days behind |
| jmock | 2.8.2 | 2.12.0 | 1007 days behind |
| jna | 5.4.0 | 5.5.0 | 140 days behind |
| joda-convert | 1.9.2 | 2.2.1 | 762 days behind |
| jsoup | 1.12.1 | 1.13.1 | 38 days behind |
| junit | 4.12 | 4.13 | 77 days behind |
...
| maven-doxia-sitetools | 1.9.1 | 1.9.2 | 28 days behind |
| maven-enforcer | 3.0.0~M2 | 3.0.0~M3 | 121 days behind |
...
| maven-plugin-build-helper | 1.9.1 | 3.0.0 | 1579 days behind |
| maven-plugin-bundle | 3.5.1 | 4.2.1 | 568 days behind |
| maven-plugin-testing | 3.3.0 | 3.3.0 | current |
| maven-plugin-tools | 3.5.1 | 3.6.0 | 668 days behind |
| maven-remote-resources-plugin | 1.5 | 1.7.0 | 507 days behind |
...
| maven-surefire | 2.22.0 | 3.0.0~M4 | 528 days behind |
| maven-verifier | 1.6 | 1.6 | current |
| maven-wagon | 3.2.0 | 3.3.4 | 440 days behind |
| modello | 1.10.0 | 1.11 | 282 days behind |
| mojo-parent | 40 | 50 | 479 days behind |
...
| plexus-bsh-factory | 1.0~alpha7 | 1.0~alpha9 | 4861 days behind |
...
| resteasy | 3.0.26 | 4.4.2 | 1191 days behind |
...
| snappy-java | 1.1.2.4 | 1.1.7.3 | 1385 days behind |
| sonatype-oss-parent | 7 | 7 | current |
| spec-version-maven-plugin | 1.2 | 2.1 | 569 days behind |
| spice-parent | 26 | 26 | current |
| stax-ex | 1.7.7 | 1.8.2 | 1160 days behind |
| stax2-api | 4.2 | 4.2 | current |
| testng | 6.14.3 | 7.1.0 | 214 days behind |
...
| xbean | 4.15 | 4.16 | 47 days behind |
| xmlstreambuffer | 1.5.4 | 1.5.8 | 637 days behind |
