...
| ------- | ------------ | ------------ | ------ |
| ant | 1.10.6 | 1.10.7 | 215 days behind |
...
| apache-commons-vfs | 2.4.1 | 2.6.0 | 100 days behind |
| apache-ivy | 2.4.0 | 2.5.0 | 166 days behind |
| apache-parent | 23 | 23 | current |
| apache-resource-bundles | 2 | 2 | current |
| apiguardian | 1.1.0 | 1.1.0 | current |
| aqute-bnd | 3.5.0 | 5.0.0 | 693 days behind |
| args4j | 2.33 | 2.33 | current |
| assertj-core | 3.8.0 | 3.15.0 | 822 days behind |
...
| cdi-api | 1.2 | 2.0.0 | 1060 days behind |
| codemodel | 2.6 | 2.6 | current |
| dain-snappy | 0.4 | 0.4 | current |
| disruptor | 3.3.6 | 3.4.2 | 918 days behind |
| easymock | 3.6 | 4.2 | 524 days behind |
| exec-maven-plugin | 1.6.0 | 1.6.0 | current |
| fasterxml-oss-parent | 38 | 38 | current |
| felix-bundlerepository | 2.0.10 | 2.0.10 | current |
| felix-framework | 5.6.0 | 6.0.3 | 1260 days behind |
| felix-osgi-obr | 1.0.2 | 1.0.2 | current |
| felix-osgi-obr-resolver | 1.8.0 | 2.0.0 | 1289 days behind |
| felix-parent | 4 | 6 | 715 days behind |
...
| glassfish-dtd-parser | 1.4 | 1.4.2 | 462 days behind |
| glassfish-fastinfoset | 1.2.15 | 1.2.18 | 463 days behind |
| glassfish-hk2 | 2.5.0 | 2.6.1 | 247 days behind |
| glassfish-jax-rs-api | 2.1.6 | 2.1.6 | current |
| glassfish-jaxb | 2.2.11 | 2.3.2 | 975 days behind |
| glassfish-jaxb-api | 2.2.12~b141001.1542 | 2.3.1 | 1992 days behind |
...
| istack-commons | 2.21 | 3.0.10 | 1761 days behind |
...
| janino | 2.7.8 | 3.1.2 | 1366 days behind |
| jansi | 1.18 | 1.18 | current |
| jansi-native | 1.8 | 1.8 | current |
| java_cup | 0.11~beta | 0.11~beta | current |
| javacc | 7.0.4 | 7.0.5 | 166 days behind |
| javacc-maven-plugin | 2.6 | 2.6 | current |
| javaparser | 3.3.5 | 3.15.17 | 929 days behind |
| javassist | 3.21.0 | 3.27.0 | 906 days behind |
| jaxen | 1.2.0 | 1.2.0 | current |
| jboss-annotations-1.2-api | 1.0.2 | 1.0.2 | current |
| jboss-el-2.2-api | 1.0.5 | 1.0.6 | 1465 days behind |
| jboss-el-3.0-api | 1.0.13 | 2.0.0 | 205 days behind |
| jboss-interceptors-1.2-api | 1.0.1 | 2.0.0 | 206 days behind |
| jboss-jaxrs-2.0-api | 1.0.0 | 1.0.1 | 802 days behind |
| jboss-logging | 3.4.1 | 3.4.1 | current |
| jboss-logging-tools | 2.2.0 | 2.2.1 | 134 days behind |
| jboss-modules | 1.5.2 | 1.9.2 | 1102 days behind |
| jboss-servlet-3.0-api | 1.0.2 | 1.0.2 | current |
| jboss-servlet-3.1-api | 1.0.2 | 1.0.2 | current |
| jctools | 2.1.2 | 3.0.0 | 91 days behind |
...
| maven-enforcer | 3.0.0~M2 | 3.0.0~M3 | 137 days behind |
...
| maven-javadoc-plugin | 3.1.1 | 3.2.0 | 22 days behind |
| maven-osgi | 0.2.0 | 0.2.0 | current |
| maven-parent | 34 | 34 | current |
| maven-plugin-build-helper | 1.9.1 | 3.0.0 | 1595 days behind |
| maven-plugin-bundle | 3.5.1 | 4.2.1 | 584 days behind |
| maven-plugin-testing | 3.3.0 | 3.3.0 | current |
| maven-plugin-tools | 3.6.0 | 3.6.0 | current |
| maven-remote-resources-plugin | 1.5 | 1.7.0 | 523 days behind |
...
| maven-surefire | 2.22.0 | 3.0.0~M4 | 544 days behind |
| maven-verifier | 1.6 | 1.7.0 | 7 days behind |
| maven-wagon | 3.2.0 | 3.3.4 | 456 days behind |
| modello | 1.10.0 | 1.11 | 298 days behind |
| mojo-parent | 40 | 50 | 495 days behind |
...
| resteasy | 3.0.26 | 4.4.2 | 1207 days behind |
...
| snappy-java | 1.1.2.4 | 1.1.7.3 | 1401 days behind |
| sonatype-oss-parent | 7 | 7 | current |
| spec-version-maven-plugin | 1.2 | 2.1 | 585 days behind |
| spice-parent | 26 | 26 | current |
| stax-ex | 1.7.7 | 1.8.3 | 1176 days behind |
| stax2-api | 4.2 | 4.2 | current |
| testng | 6.14.3 | 7.1.0 | 230 days behind |
...
| xbean | 4.15 | 4.16 | 63 days behind |
| xmlstreambuffer | 1.5.4 | 1.5.9 | 653 days behind |
