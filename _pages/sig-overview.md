...
| ------- | ------------ | ------------ | ------ |
| ant | 1.10.6 | 1.10.7 | 188 days behind |
| ant-antunit | 1.3 | 1.4 | 624 days behind |
...
| cdi-api | 1.2 | 2.0.0 | 1033 days behind |
| codemodel | 2.6 | 2.6 | current |
| dain-snappy | 0.4 | 0.4 | current |
| disruptor | 3.3.6 | 3.4.2 | 891 days behind |
| easymock | 3.6 | 4.2 | 497 days behind |
| exec-maven-plugin | 1.6.0 | 1.6.0 | current |
| fasterxml-oss-parent | 38 | 38 | current |
| felix-bundlerepository | 2.0.10 | 2.0.10 | current |
| felix-framework | 5.6.0 | 6.0.3 | 1233 days behind |
| felix-osgi-obr | 1.0.2 | 1.0.2 | current |
| felix-osgi-obr-resolver | 1.8.0 | 2.0.0 | 1262 days behind |
| felix-parent | 4 | 6 | 688 days behind |
...
| glassfish-dtd-parser | 1.4 | 1.4.2 | 435 days behind |
| glassfish-fastinfoset | 1.2.15 | 1.2.17 | 436 days behind |
| glassfish-hk2 | 2.5.0 | 2.6.1 | 220 days behind |
| glassfish-jax-rs-api | 2.1.6 | 2.1.6 | current |
| glassfish-jaxb | 2.2.11 | 2.3.2 | 948 days behind |
| glassfish-jaxb-api | 2.2.12~b141001.1542 | 2.3.1 | 1965 days behind |
...
| guava | 25.0 | 28.2 | 654 days behind |
| guava20 | 20.0 | 20.0 | current |
| hamcrest | 1.3 | 2.2 | 443 days behind |
| hawtjni | 1.17 | 1.17 | current |
| httpcomponents-project | 11 | 11 | current |
| isorelax | 0 | 0 | current |
| istack-commons | 2.21 | 3.0.10 | 1734 days behind |
| jackson-annotations | 2.10.3 | 2.20.3 | 4 days behind |
| jackson-core | 2.10.3 | 2.20.3 | 4 days behind |
| jackson-databind | 2.10.3 | 2.20.3 | 4 days behind |
| jackson-jaxrs-providers | 2.10.3 | 2.20.3 | 4 days behind |
| jackson-modules-base | 2.10.3 | 2.20.3 | 4 days behind |
| jackson-parent | 2.10 | 2.10 | current |
| jakarta-commons-httpclient | 3.1 | 3.1 | current |
| janino | 2.7.8 | 3.1.0 | 1339 days behind |
| jansi | 1.18 | 1.18 | current |
| jansi-native | 1.8 | 1.8 | current |
| java_cup | 0.11~beta | 0.11~beta | current |
| javacc | 7.0.4 | 7.0.5 | 139 days behind |
| javacc-maven-plugin | 2.6 | 2.6 | current |
| javaparser | 3.3.5 | 3.15.11 | 902 days behind |
| javassist | 3.18.1 | 3.26.0 | 2111 days behind |
| jaxen | 1.2.0 | 1.2.0 | current |
| jboss-annotations-1.2-api | 1.0.2 | 1.0.2 | current |
| jboss-el-2.2-api | 1.0.5 | 1.0.6 | 1438 days behind |
| jboss-el-3.0-api | 1.0.13 | 2.0.0 | 178 days behind |
| jboss-interceptors-1.2-api | 1.0.1 | 2.0.0 | 179 days behind |
| jboss-jaxrs-2.0-api | 1.0.0 | 1.0.1 | 775 days behind |
| jboss-logging | 3.4.1 | 3.4.1 | current |
| jboss-logging-tools | 2.2.0 | 2.2.1 | 107 days behind |
| jboss-modules | 1.5.2 | 1.9.2 | 1075 days behind |
| jboss-servlet-3.0-api | 1.0.2 | 1.0.2 | current |
| jboss-servlet-3.1-api | 1.0.2 | 1.0.2 | current |
| jctools | 2.1.2 | 3.0.0 | 64 days behind |
| jdeparser | 2.0.3 | 2.0.3 | current |
| jdepend | 2.9.1 | 2.9.1 | current |
| jdependency | 1.2 | 2.3.0 | 795 days behind |
| jdom2 | 2.0.6 | 2.0.6 | current |
| jetty-parent | 19 | 25 | 2756 days behind |
| jetty-toolchain | 1.4 | 1.7 | 1832 days behind |
| jflex | 1.7.0 | 1.8.0 | 8 days behind |
| jmock | 2.8.2 | 2.12.0 | 996 days behind |
| jna | 5.4.0 | 5.5.0 | 129 days behind |
| joda-convert | 1.9.2 | 2.2.1 | 751 days behind |
| jsoup | 1.12.1 | 1.13.1 | 27 days behind |
| junit | 4.12 | 4.13 | 66 days behind |
...
| maven-doxia-sitetools | 1.9.1 | 1.9.2 | 17 days behind |
| maven-enforcer | 3.0.0~M2 | 3.0.0~M3 | 110 days behind |
...
| maven-parent | 33 | 34 | 41 days behind |
| maven-plugin-build-helper | 1.9.1 | 3.0.0 | 1568 days behind |
| maven-plugin-bundle | 3.5.1 | 4.2.1 | 557 days behind |
| maven-plugin-testing | 3.3.0 | 3.3.0 | current |
| maven-plugin-tools | 3.5.1 | 3.6.0 | 657 days behind |
| maven-remote-resources-plugin | 1.5 | 1.7.0 | 496 days behind |
...
| maven-source-plugin | 3.2.0 | 3.2.1 | 82 days behind |
| maven-surefire | 2.22.0 | 3.0.0~M4 | 517 days behind |
| maven-verifier | 1.6 | 1.6 | current |
| maven-wagon | 3.2.0 | 3.3.4 | 429 days behind |
| modello | 1.10.0 | 1.11 | 271 days behind |
| mojo-parent | 40 | 50 | 468 days behind |
| munge-maven-plugin | 1.0 | 1.0 | current |
| objectweb-pom | 1.5 | 1.5 | current |
| opentest4j | 1.1.0 | 1.2.0 | 544 days behind |
...
| plexus-bsh-factory | 1.0~alpha7 | 1.0~alpha9 | 4850 days behind |
...
| plexus-languages | 1.0.5 | 1.0.5 | current |
| plexus-pom | 6.2 | 6.2 | current |
...
| resteasy | 3.0.26 | 4.4.2 | 1180 days behind |
...
| snappy-java | 1.1.2.4 | 1.1.7.3 | 1374 days behind |
| sonatype-oss-parent | 7 | 7 | current |
| spec-version-maven-plugin | 1.2 | 2.1 | 558 days behind |
| spice-parent | 26 | 26 | current |
| stax-ex | 1.7.7 | 1.8.2 | 1149 days behind |
| stax2-api | 4.2 | 4.2 | current |
| testng | 6.14.3 | 7.1.0 | 203 days behind |
...
| woodstox-core | 6.1.1 | 6.1.1 | current |
| xalan-j2 | 2.7.2 | 2.7.2 | current |
| xbean | 4.15 | 4.16 | 36 days behind |
| xmlstreambuffer | 1.5.4 | 1.5.8 | 626 days behind |
