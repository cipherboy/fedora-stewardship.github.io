...
| ------- | ------------ | ------------ | ------ |
| ant | 1.10.6 | 1.10.7 | 184 days behind |
| ant-antunit | 1.3 | 1.4 | 620 days behind |
...
| apache-commons-compress | 1.19 | 1.20 | 27 days behind |
| apache-commons-daemon | 1.2.2 | 1.2.2 | current |
| apache-commons-jxpath | 1.3 | 1.3 | current |
| apache-commons-lang | 2.6 | 2.6 | current |
| apache-commons-vfs | 2.4.1 | 2.6.0 | 69 days behind |
| apache-ivy | 2.4.0 | 2.5.0 | 135 days behind |
| apache-parent | 22 | 23 | 41 days behind |
| apache-resource-bundles | 2 | 2 | current |
| apiguardian | 1.1.0 | 1.1.0 | current |
| aqute-bnd | 3.5.0 | 5.0.0 | 662 days behind |
| args4j | 2.33 | 2.33 | current |
| assertj-core | 3.8.0 | 3.15.0 | 791 days behind |
...
| cdi-api | 1.2 | 2.0.0 | 1029 days behind |
| codemodel | 2.6 | 2.6 | current |
| cpptasks | 1.0~b5 | 1.0~b5 | current |
| dain-snappy | 0.4 | 0.4 | current |
| disruptor | 3.3.6 | 3.4.2 | 887 days behind |
| easymock | 3.6 | 4.2 | 493 days behind |
| exec-maven-plugin | 1.6.0 | 1.6.0 | current |
| fasterxml-oss-parent | 38 | 38 | current |
| felix-bundlerepository | 2.0.10 | 2.0.10 | current |
| felix-framework | 5.6.0 | 6.0.3 | 1229 days behind |
| felix-osgi-obr | 1.0.2 | 1.0.2 | current |
| felix-osgi-obr-resolver | 1.8.0 | 2.0.0 | 1258 days behind |
| felix-parent | 4 | 6 | 684 days behind |
| felix-shell | 1.4.3 | 1.4.3 | current |
| felix-utils | 1.11.2 | 1.11.4 | 114 days behind |
...
| glassfish-dtd-parser | 1.4 | 1.4.2 | 431 days behind |
| glassfish-fastinfoset | 1.2.15 | 1.2.17 | 432 days behind |
| glassfish-hk2 | 2.5.0 | 2.6.1 | 216 days behind |
| glassfish-jax-rs-api | 2.1.6 | 2.1.6 | current |
| glassfish-jaxb | 2.2.11 | 2.3.2 | 944 days behind |
| glassfish-jaxb-api | 2.2.12~b141001.1542 | 2.3.1 | 1961 days behind |
...
| guava | 25.0 | 28.2 | 650 days behind |
| guava20 | 20.0 | 20.0 | current |
| hamcrest | 1.3 | 2.2 | 439 days behind |
| hawtjni | 1.17 | 1.17 | current |
| httpcomponents-project | 11 | 11 | current |
| isorelax | 0 | 0 | current |
| istack-commons | 2.21 | 3.0.10 | 1730 days behind |
| jackson-annotations | 2.10.2 | 2.20.3 | 0 days behind |
| jackson-core | 2.10.2 | 2.20.3 | 0 days behind |
| jackson-databind | 2.10.2 | 2.20.3 | 0 days behind |
| jackson-jaxrs-providers | 2.10.2 | 2.20.3 | 34 days behind |
| jackson-modules-base | 2.10.2 | 2.20.3 | 0 days behind |
| jackson-parent | 2.10 | 2.10 | current |
| jakarta-commons-httpclient | 3.1 | 3.1 | current |
| janino | 2.7.8 | 3.1.0 | 1335 days behind |
| jansi | 1.18 | 1.18 | current |
| jansi-native | 1.8 | 1.8 | current |
| java_cup | 0.11~beta | 0.11~beta | current |
| javacc | 7.0.4 | 7.0.5 | 135 days behind |
| javacc-maven-plugin | 2.6 | 2.6 | current |
| javaparser | 3.3.5 | 3.15.11 | 898 days behind |
| javassist | 3.18.1 | 3.26.0 | 2107 days behind |
| jaxen | 1.2.0 | 1.2.0 | current |
| jboss-annotations-1.2-api | 1.0.2 | 1.0.2 | current |
| jboss-el-2.2-api | 1.0.5 | 1.0.6 | 1434 days behind |
| jboss-el-3.0-api | 1.0.13 | 2.0.0 | 174 days behind |
| jboss-interceptors-1.2-api | 1.0.1 | 2.0.0 | 175 days behind |
| jboss-jaxrs-2.0-api | 1.0.0 | 1.0.1 | 771 days behind |
| jboss-logging | 3.4.1 | 3.4.1 | current |
| jboss-logging-tools | 2.2.0 | 2.2.1 | 103 days behind |
| jboss-modules | 1.5.2 | 1.9.2 | 1071 days behind |
| jboss-servlet-3.0-api | 1.0.2 | 1.0.2 | current |
| jboss-servlet-3.1-api | 1.0.2 | 1.0.2 | current |
| jctools | 2.1.2 | 3.0.0 | 60 days behind |
| jdeparser | 2.0.3 | 2.0.3 | current |
| jdepend | 2.9.1 | 2.9.1 | current |
| jdependency | 1.2 | 2.3.0 | 791 days behind |
| jdom2 | 2.0.6 | 2.0.6 | current |
| jetty-build-support | 1.4 | 1.5 | 460 days behind |
| jetty-parent | 19 | 25 | 2752 days behind |
| jetty-toolchain | 1.4 | 1.7 | 1828 days behind |
| jflex | 1.7.0 | 1.8.0 | 4 days behind |
| jmock | 2.8.2 | 2.12.0 | 992 days behind |
| jna | 5.4.0 | 5.5.0 | 125 days behind |
| joda-convert | 1.9.2 | 2.2.1 | 747 days behind |
| jsoup | 1.12.1 | 1.13.1 | 23 days behind |
| junit | 4.12 | 4.13 | 62 days behind |
| junit5 | 5.6.0 | 5.6.0 | current |
| jvnet-parent | 5 | 5 | current |
| kxml | 2.3.0 | 2.3.0 | current |
| log4j | 2.13.0 | 2.13.1 | 6 days behind |
| log4j12 | 1.2.17 | 1.2.17 | current |
| maven | 3.6.1 | 3.6.3 | 189 days behind |
| maven-antrun-plugin | 1.8 | 1.8 | current |
| maven-archiver | 3.5.0 | 3.5.0 | current |
| maven-artifact-resolver | 1.0 | 1.0 | current |
| maven-artifact-transfer | 0.11.0 | 0.12.0 | 98 days behind |
| maven-assembly-plugin | 3.2.0 | 3.2.0 | current |
| maven-clean-plugin | 3.1.0 | 3.1.0 | current |
| maven-common-artifact-filters | 3.0.1 | 3.1.0 | 444 days behind |
...
| maven-doxia-sitetools | 1.9.1 | 1.9.2 | 13 days behind |
| maven-enforcer | 3.0.0~M2 | 3.0.0~M3 | 106 days behind |
...
| maven-parent | 33 | 34 | 37 days behind |
| maven-plugin-build-helper | 1.9.1 | 3.0.0 | 1564 days behind |
| maven-plugin-bundle | 3.5.1 | 4.2.1 | 553 days behind |
| maven-plugin-testing | 3.3.0 | 3.3.0 | current |
| maven-plugin-tools | 3.5.1 | 3.6.0 | 653 days behind |
| maven-remote-resources-plugin | 1.5 | 1.7.0 | 492 days behind |
...
| maven-source-plugin | 3.2.0 | 3.2.1 | 78 days behind |
| maven-surefire | 2.22.0 | 3.0.0~M4 | 513 days behind |
| maven-verifier | 1.6 | 1.6 | current |
| maven-wagon | 3.2.0 | 3.3.4 | 425 days behind |
| modello | 1.10.0 | 1.11 | 267 days behind |
| mojo-parent | 40 | 50 | 464 days behind |
| munge-maven-plugin | 1.0 | 1.0 | current |
| mvel | 2.2.8 | 2.4.7 | 1357 days behind |
| objectweb-pom | 1.5 | 1.5 | current |
| opentest4j | 1.1.0 | 1.2.0 | 540 days behind |
...
| plexus-archiver | 4.2.1 | 4.2.2 | 3 days behind |
| plexus-bsh-factory | 1.0~alpha7 | 1.0~alpha9 | 4846 days behind |
...
| plexus-languages | 1.0.3 | 1.0.5 | 93 days behind |
| plexus-pom | 6.1 | 6.2 | 13 days behind |
...
| snappy-java | 1.1.2.4 | 1.1.7.3 | 1370 days behind |
| sonatype-oss-parent | 7 | 7 | current |
| spec-version-maven-plugin | 1.2 | 2.1 | 554 days behind |
| spice-parent | 26 | 26 | current |
| stax-ex | 1.7.7 | 1.8.2 | 1145 days behind |
| stax2-api | 4.2 | 4.2 | current |
| testng | 6.14.3 | 7.1.0 | 199 days behind |
...
| woodstox-core | 6.0.3 | 6.1.1 | 5 days behind |
| xalan-j2 | 2.7.2 | 2.7.2 | current |
| xbean | 4.15 | 4.16 | 32 days behind |
| xmlstreambuffer | 1.5.4 | 1.5.8 | 622 days behind |
